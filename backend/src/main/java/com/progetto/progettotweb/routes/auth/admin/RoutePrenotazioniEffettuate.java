...
@WebServlet(name = "prenotazionieffettuate", value = "/api/auth/admin/prenotazionieffettuate")
public class RoutePrenotazioniEffettuate extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        idUtente = u.getId();
        ArrayList<Ripetizione> ripetizioni = ripetizioneController.queryDBRipetizioniPrenotate(idUtente);
